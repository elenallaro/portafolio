                    ...
                    <div class="col-md-4 d-flex align-items-center">
                        <a href="/" class="mb-3 me-2 mb-md-0 text-body-secondary text-decoration-none lh-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                                class="bi bi-hearts hearts2 lg" viewBox="0 0 16 16">
                        ...
                        <span class="mb-3 mb-md-0 text-body-secondary" style="color: rgb(240, 229, 223);"> Elena Romero, 2023.</span>
                    </div>

                    <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
                        <li class="ms-3"><a class="text-body-secondary" href="https://github.com/elenallaro">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-github lg" style="color: rgb(240, 229, 223);" viewBox="0 0 16 16">
                        ...
                        <li class="ms-3"><a class="text-body-secondary" href="https://www.linkedin.com/in/elenallaro/">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-linkedin lg" style="color: rgb(240, 229, 223);" viewBox="0 0 16 16">
                        ...
                        <li class="ms-3"><a class="text-body-secondary" href="./src/cv/CV Programadora.pdf">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-clipboard2-heart-fill lg" style="color: rgb(240, 229, 223);" viewBox="0 0 16 16">
            ...
            <div class="container-fluid">
                <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
                    <a href="/"
                        ...
                        <span class="fs-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-hearts txcl1" viewBox="0 0 16 16">
                    ...
                    <ul class="nav nav-pills">
                        <li class="nav-item"><a href="../index.html" class="nav-link navtxt2">Inicio</a></li>
                        <li class="nav-item"><a href="../pages/about.html" class="nav-link navtxt2">Sobre mí</a></li>
                        <li class="nav-item"><a href="../pages/prog.html" class="nav-link navtxt2">Desarrolladora web</a></li>
                        <li class="nav-item"><a href="../pages/biol.html" class="nav-link navtxt2">Bióloga</a></li>
                        <li class="nav-item"><a href="../pages/contact.html" class="nav-link navtxt2">Contacto</a></li>
                    </ul>
                </header>
            </div>
                <!-- Termina Navbar -->
